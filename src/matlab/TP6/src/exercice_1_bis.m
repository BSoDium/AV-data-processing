...
% Point fixe :
lambda = 10; % Poids de la r�gularisation
u_k_r = u0_r;
u_k_g = u0_g;
u_k_b = u0_b;
convergence = +Inf;
...
while convergence > 1e-3
  ...
  % It�ration (6) :
  u_kp1_r = debruitage(b_r, u_k_r, lambda, Dx, Dy, epsilon);
  u_kp1_g = debruitage(b_g, u_k_g, lambda, Dx, Dy, epsilon);
  u_kp1_b = debruitage(b_b, u_k_b, lambda, Dx, Dy, epsilon);
