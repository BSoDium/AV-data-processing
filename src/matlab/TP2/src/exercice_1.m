...
% Tracè du modèle exact (trait noir) :
...
% Calcul des donnèes d'apprentissage (bruit blanc sur les ordonnèes) :
n_app = 50;
pas_app = 1 / (n_app - 1);
x_j = 0:pas_app:1;
sigma = 0.5;
...
% Tracè des donnèes d'apprentissage (croix bleues) :
...
% Tracè de la courbe de Bèzier estimèe, de degrè d (trait rouge) :
