...
% Param�tres de la m�thode de segmentation :
T_0 = 1.0;
alpha = 0.99;
q_max = 50;
beta = 2.0;

% Estimation des param�tres des N classes :
N = 4;
[moyennes, variances] = estimation_non_super(I, N, couleurs_classes);
...
% Calcul de l'attache aux donn�es (vraisemblance) :
...
% Minimisation de l'�nergie par recuit simul� :
temps_affichage = 0.05;
T = T_0;

for q = 1:q_max

  % Boucle du recuit simul� :
...
% Calcul du pourcentage de pixels correctement class�s :
